---
id: 2
title: "Docusaurus Content Update"
stage: "misc"
date_iso: "2025-11-28"
surface: "agent"
...
branch: "master"
user: "unknown"
command: "replace the pre made content in docusaurus project with my current Topic's research i.e: Robotics / The course details are as follows : Physical AI & Humanoid Robotics..."
labels: ["docusaurus", "content-update"]
links:
  spec: null
  ticket: null
  adr: null
  pr: null
files_yaml:
  - docusaurus/docs/robotics-course/intro.md
  - docusaurus/docs/robotics-course/modules.md
  - docusaurus/docs/robotics-course/why-it-matters.md
  - docusaurus/docs/robotics-course/weekly-breakdown.md
  - docusaurus/docs/robotics-course/hardware-requirements.md
  - docusaurus/docs/robotics-course/architecture-summary.md
  - docusaurus/docs/robotics-course/cloud-native-lab.md
  - docusaurus/docs/robotics-course/economy-jetson-kit.md
  - docusaurus/docs/robotics-course/latency-trap.md
  - docusaurus/sidebars.ts
  - docusaurus/docs/intro.md (removed)
  - docusaurus/docs/tutorial-basics (removed)
  - docusaurus/docs/tutorial-extras (removed)
tests_yaml: []
---
...
```text
alrightok, replace the pre made content with the content I have given replace the content which is pre made in docusaurus with this content : The Course Details
...
Module 2: Ttters
Humanoid robots are pohe Digital Twin (Gazebo & Unity)
...
Why Physical AI Maised to excel in our human-centered world because they share our physical form and can be trained with abundant data from interacting in human environments. This represents a significant transition from AI models confined to digital environments to embodied intelligence that operates in physical space.
Learning Outcomes
...
Best for: Learning ROS 2, Basic Computer Vision, and Sim-to-Real control Dev Kit)
$0
...
have you replaced the content of docusaurus ?
```

## Response

```text
I have successfully replaced the premade content in the Docusaurus project with your Robotics course details, updated the sidebar, and cleaned up the old content. The new documentation is organized under the 'Robotics Course' category in the sidebar.
...
Docusaurus content successfully updated and PHR created.
