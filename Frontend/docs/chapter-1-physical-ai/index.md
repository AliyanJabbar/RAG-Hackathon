...
This chapter introduces the foundational concepts of Physical AI and Embodied Intelligence. We will explore how physical robots interact with the real world, the importance of sensorimotor intelligence, and the role of physics-aware reasoning in enabling advanced robotic behaviors. The chapter also delves into the various sensors humanoids use, the control loops that govern their actions, and profiles some of the most advanced modern humanoids. Finally, we will define key terminology and outline the learning objectives for this module.
...
1.  [What is Physical AI?](/docs/chapter-1-physical-ai/01-what-is-physical-ai)
2.  [Embodiment](/docs/chapter-1-physical-ai/02-embodiment)
3.  [Sensorimotor Intelligence](/docs/chapter-1-physical-ai/03-sensorimotor-intelligence)
4.  [Physics-Aware Reasoning](/docs/chapter-1-physical-ai/04-physics-aware-reasoning)
5.  [Humanoid Sensors](/docs/chapter-1-physical-ai/05-humanoid-sensors)
6.  [Robotic Control Loops](/docs/chapter-1-physical-ai/06-robotic-control-loops)
7.  [Modern Humanoids](/docs/chapter-1-physical-ai/07-modern-humanoids)
